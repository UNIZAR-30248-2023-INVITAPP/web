import { anadirEventoPrueba, eliminarEventoDom, anadirEventoPruebaDom } from "../aux-funciones"
...
describe('Comprobar que aparece un boton de eliminar evento en cada evento', () => {
    ...
    it('Prueba 2: Crear 2 eventos', () => {
      anadirEventoPruebaDom("Test Eliminar Evento - Evento 1")
      anadirEventoPruebaDom("Test Eliminar Evento - Evento 2")
